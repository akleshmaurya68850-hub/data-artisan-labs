...
export const Footer = () => {
  const socialLinks = [
    { icon: Github, href: "https://github.com/aklesh-ds", label: "GitHub" },
    { icon: Linkedin, href: "https://linkedin.com/in/aklesh-ds", label: "LinkedIn" },
    { icon: ExternalLink, href: "https://kaggle.com/akleshds", label: "Kaggle" },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-semibold">Aklesh Kumar</p>
          ...
          <div className="mt-8 pt-8 border-t border-border/50 text-center">
            <p className="text-sm text-muted-foreground flex items-center justify-center gap-1">
              © 2026 Aklesh Kumar. Built with <Heart className="w-4 h-4 text-red-500" /> and Data Science
            </p>
          </div>
        </div>
      </div>
